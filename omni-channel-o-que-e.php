    ...
    <?php require(__DIR__."/components/page_header.html");?>
      ...
      <div class="col-md-9" style="padding-top: 5%; padding-right:10%; padding-left: 10%; padding-bottom: 5%">
        <span class="post">
          ...
          <h2><p align="justify">Quer saber mais ? Quer saber como essa nova tendência já utilizada por algumas empresas, como a Apple ? <a class="signUpModal" href="#"><b>Clica</b></a> no banner e descubra.</p></h2>
