  ...
  <body>
    ...
    <?php require(__DIR__."/components/page_header.html");?>
      ...
      <div class="clearfix colelem" id="u12639-32"><!-- content -->
        <h3><p align="justify">Na última sexta-feira foi deflagrada a maior operação da história da Polícia Federal. A operação investiga empresas do setor alimentício envolvidas em um esquema de corrupção que liberava a comercialização de alimentos produzidos por frigoríficos sem a devida fiscalização sanitária.</p></h3>
        <h6>&nbsp;</h6>

        <h3><p align="justify">Com todo esse aué, você varejista que possui em suas prateleiras produtos que são alvos dessa operação, deve estar se perguntando o que fazer? Tirar os produtos dessas empresas das prateleiras? Como devo orientar o consumidor que pretende adquirir o produto? Devo me preocupar com a fiscalização sanitária no meu estabelecimento? Terão implicações para o meu negócio?</p></h3>
        <h6>&nbsp;</h6>
        ...
        <h6>&nbsp;</h6>
        <h3><p align="justify">O mais importante é saber lidar com o consumidor e acalma-lo. Trata-se de uma investigação da polícia federal que ainda não se tornou um processo judicial com a formalização das acusações e tipificação de crimes... Vamos aguardar as cenas dos próximos capítulos..!</p></h3>
        <h6>&nbsp;</h6>
